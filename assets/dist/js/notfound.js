...
function typewriter(){
    if ($("#typewriter").length) {
        ...
        typewriter.typeString('Page Not Found').pauseFor(2000).deleteAll()
            .typeString('Halaman Tidak Ditemukan').pauseFor(2000).deleteAll()
            .typeString('Are you sure?').pauseFor(2000).start();
    }
}
